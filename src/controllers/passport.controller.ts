...
export const createPassportFromObject = async (passportData: {
    ...
    try {
        ...
        const { id, citizen_id, citizen_identity_id, issue_date, expire_date, phone_number } = passportData;

        if (!id || !citizen_id || !citizen_identity_id || !issue_date || !expire_date || !phone_number) {
